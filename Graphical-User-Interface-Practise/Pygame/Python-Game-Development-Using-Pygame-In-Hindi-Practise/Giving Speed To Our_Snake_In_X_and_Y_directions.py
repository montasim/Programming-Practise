 ...
 #    Date      : Created on 
 #    Version   : 1.0.1
 #    Purpose   : Giving Speed To Our Snake In X and Y directions
 #    Input     : none
 #    Output    : Giving Speed To Our Snake In X and Y directions
 #    ------------------------------------------------------------------------------------------
...
snake_velocity_x = 4    #   snake velocity in x axis
snake_velocity_y = 4    #   snake velocity in y axis
